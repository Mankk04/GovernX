...
Wires together Auth, Accounts, Findings, Scores, Risk, Reports, and Audit
routers behind a single REST API surface (Section 19).
"""
...
from app.api import (
    ...
    routes_risk, routes_reports, routes_audit,
)
